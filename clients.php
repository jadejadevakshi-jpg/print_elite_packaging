...
<html lang="en">
  <head>
    ...
    <title>Clients | Elite Print</title>
  ...
  <body class="has-mesh">
    ...
    <main id="main-content" class="page-fade">
      <section class="page-hero section--dark">
        <div class="container">
          <p class="page-hero__crumb"><a href="index.php">Home</a> / Clients</p>
          <h1 class="page-hero__title">Our clients</h1>
          <p style="max-width: 560px; color: rgba(250, 250, 250, 0.78)">Loaded from the database.</p>
        </div>
      </section>

      <section class="section" id="clients">
        <div class="container">
          <p class="section__eyebrow reveal">Trusted partners</p>
          <h2 class="section__title reveal">Our Clients</h2>
          <p class="section__subtitle reveal">Manage clients in Admin → Clients.</p>
          <div class="clients-grid">
            <?php foreach ($clients as $c): ?>
              <div class="client-logo client-logo--fx reveal"><?php echo h((string)$c['name']); ?></div>
            <?php endforeach; ?>
          </div>
        </div>
      </section>
